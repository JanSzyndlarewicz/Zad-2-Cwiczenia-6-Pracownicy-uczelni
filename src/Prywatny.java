public class Prywatny extends Klient{
    ...
    public Prywatny(String name, String second_name, String id, String birthdate, String nrKarty, int znizka, int pkt, int iloscDzieci, boolean czyZamozny, int limit) {
